...
/*   Updated: 2022/07/10 19:18:19 by tdehne           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	*s_x = (int)((w_x + g_vars->offset_x) * g_vars->zoom_x);
	*s_y = (int)((g_vars->offset_y - w_y) * g_vars->zoom_y);
}
...
{
	*w_x = (double)(s_x / g_vars->zoom_x - g_vars->offset_x);
	*w_y = (double)(g_vars->offset_y - s_y / g_vars->zoom_y);
}